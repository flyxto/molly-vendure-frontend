...
export default function Hero2() {
  return (
    <div
      className="min-h-[100svh] relative overflow-hidden dm-sans flex py-28 "
      style={{
    ...
    >
      {/* Heading */}
      <div className="w-full h-fit max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center lg:text-left relative z-20 flex flex-col items-center lg:items-start">
      ...
      <motion.div
        ...
        className="absolute bottom-0 -right-12 sm:-right-16 md:-right-20 lg:-right-24 hidden lg:block z-20 w-48 sm:w-64 md:w-80 lg:w-[48rem] xl:w-[56rem]"
      >
        <img
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 md:hidden z-20 flex justify-center"
      >
        <img
          src="/images/home-page/hero-img-1.webp"
          alt="hero-2"
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 right-0 hidden lg:hidden z-20 md:flex justify-center"
      >
        <img
          src="/images/home-page/hero-img-2.webp"
          alt="hero-2"
